...
var DracoDecoderModule = (function () {
	...
	return function (m) {
		...
		function h(a, c, b) {
			...
			for (d = ""; c < b; ) {
				...
				if (k & 128) {
					var e = a[c++] & 63;
					if (192 == (k & 224))
						d += String.fromCharCode(((k & 31) << 6) | e);
					else {
						var f = a[c++] & 63;
						k =
							224 == (k & 240)
		...
		a.onRuntimeInitialized = function () {
			Ga = !0;
			if (Ha && "function" === typeof a.onModuleLoaded)
				a.onModuleLoaded(a);
		};
		...
		var hb = (a.___wasm_call_ctors = function () {
			...
			jb = (a._emscripten_bind_Status_code_0 = function () {
				return a.asm.emscripten_bind_Status_code_0.apply(
					null,
					arguments
				);
			}),
			...
			lb = (a._emscripten_bind_Status_error_msg_0 = function () {
				return a.asm.emscripten_bind_Status_error_msg_0.apply(
					null,
					arguments
				);
			}),
			...
			yb = (a._emscripten_bind_DracoUInt32Array___destroy___0 =
				function () {
			...
			Vb = (a._emscripten_bind_DracoInt8Array___destroy___0 =
				function () {
			...
			Xa = (a._emscripten_bind_MetadataQuerier_MetadataQuerier_0 =
				function () {
			...
			Xb = (a._emscripten_bind_MetadataQuerier_GetIntEntry_2 =
				function () {
			...
			Zb = (a._emscripten_bind_MetadataQuerier_GetDoubleEntry_2 =
				function () {
			...
			$b = (a._emscripten_bind_MetadataQuerier_GetStringEntry_2 =
				function () {
			...
			bc = (a._emscripten_bind_MetadataQuerier_GetEntryName_2 =
				function () {
			...
			cc = (a._emscripten_bind_MetadataQuerier___destroy___0 =
				function () {
			...
			gc = (a._emscripten_bind_DracoFloat32Array_GetValue_1 =
				function () {
			...
			ic = (a._emscripten_bind_DracoFloat32Array___destroy___0 =
				function () {
			...
			bb = (a._emscripten_bind_Decoder_Decoder_0 = function () {
				return a.asm.emscripten_bind_Decoder_Decoder_0.apply(
					null,
					arguments
				);
			}),
			mc = (a._emscripten_bind_Decoder_GetEncodedGeometryType_1 =
				function () {
			...
			oc = (a._emscripten_bind_Decoder_DecodeBufferToMesh_2 =
				function () {
			...
			Mc = (a._emscripten_bind_Mesh_num_faces_0 = function () {
				return a.asm.emscripten_bind_Mesh_num_faces_0.apply(
					null,
					arguments
				);
			}),
			...
			Oc = (a._emscripten_bind_Mesh_num_points_0 = function () {
				return a.asm.emscripten_bind_Mesh_num_points_0.apply(
					null,
					arguments
				);
			}),
			Pc = (a._emscripten_bind_Mesh___destroy___0 = function () {
				return a.asm.emscripten_bind_Mesh___destroy___0.apply(
					null,
					arguments
				);
			}),
			...
			eb = (a._emscripten_bind_Metadata_Metadata_0 = function () {
				return a.asm.emscripten_bind_Metadata_Metadata_0.apply(
					null,
					arguments
				);
			}),
			...
			Vc = (a._emscripten_enum_draco_StatusCode_OK = function () {
				return a.asm.emscripten_enum_draco_StatusCode_OK.apply(
					null,
					arguments
				);
			}),
			Wc = (a._emscripten_enum_draco_StatusCode_DRACO_ERROR =
				function () {
			...
			$c = (a._emscripten_enum_draco_StatusCode_UNKNOWN_VERSION =
				function () {
		...
		r.prototype.GetDoubleEntry = r.prototype.GetDoubleEntry = function (
			a,
			b
		) {
			var c = this.ptr;
		...
		r.prototype.GetStringEntry = r.prototype.GetStringEntry = function (
			a,
			b
		) {
			var c = this.ptr;
		...
		g.__cache__ = {};
		a.Decoder = g;
		g.prototype.GetEncodedGeometryType =
			g.prototype.GetEncodedGeometryType = function (a) {
				var c = this.ptr;
				a && "object" === typeof a && (a = a.ptr);
				return mc(c, a);
			};
		...
		g.prototype.GetAttributeId = g.prototype.GetAttributeId = function (
			a,
			b
		) {
			var c = this.ptr;
		...
		g.prototype.GetAttributeByUniqueId =
			g.prototype.GetAttributeByUniqueId = function (a, b) {
				var c = this.ptr;
				a && "object" === typeof a && (a = a.ptr);
				b && "object" === typeof b && (b = b.ptr);
				return N(tc(c, a, b), q);
		...
		g.prototype.GetTrianglesUInt16Array =
			g.prototype.GetTrianglesUInt16Array = function (a, b, d) {
				var c = this.ptr;
				a && "object" === typeof a && (a = a.ptr);
				b && "object" === typeof b && (b = b.ptr);
				d && "object" === typeof d && (d = d.ptr);
		...
		g.prototype.GetTrianglesUInt32Array =
			g.prototype.GetTrianglesUInt32Array = function (a, b, d) {
				var c = this.ptr;
				a && "object" === typeof a && (a = a.ptr);
				b && "object" === typeof b && (b = b.ptr);
				d && "object" === typeof d && (d = d.ptr);
		...
		g.prototype.GetAttributeDataArrayForAllPoints =
			g.prototype.GetAttributeDataArrayForAllPoints = function (
				a,
				b,
				d,
				e,
		...
		g.prototype.SkipAttributeTransform =
			g.prototype.SkipAttributeTransform = function (a) {
				var b = this.ptr;
				a && "object" === typeof a && (a = a.ptr);
				Kc(b, a);
			};
