...
export default function PreRoomLayer(props) {
	...
	function connectClient(roomIdToConnectTo) {
		...
		window.SignalingSocket = new window.WebSocket(
			`${config.url_signaling}?roomid=${roomIdToConnectTo}&name=${_Name}`
		);
	...
	function participate() {
		...
		if (
			...
			window.SignalingSocket.readyState === 3
		) {
						...
						<div className="PRP-B-C-S-VideoShadow">
							<div className="PRP-B-C-S-VS-Video">
								...
								<div className="PRP-B-C-S-VS-V-Buttons">
									<div
										className={`PRP-B-C-S-VS-V-B-AudioButton${
											props.audio ? "On" : "Off"
										}`}
										onClick={toggleAudio}
									>
									...
									<div
										className={`PRP-B-C-S-VS-V-B-VideoButton${
											props.video ? "On" : "Off"
										}`}
										onClick={toggleVideo}
									>
