			...
			<div className="LP-Body">
				<div className="LP-B-TextAndButton">
					...
					<div className="LP-B-TAB-Text2">
						Welcome to my video meeting platform. I made this to
						show my WebRTC skills. I hope you like it and maybe find
						it useful.
					</div>
					<div className="LP-B-TAB-Button">
						<div
							className="LP-B-TAB-B-CreateNewRoom"
						...
						<div className="LP-B-TAB-B-JoinRoom">
							...
							{(_Focused || _Value.length > 0) && (
								<button
									...
									style={{
										color: Utils.idGenerator.isRoomIDValid(
											_Value
										)
											? "#1a73e8"
											: "rgba(60,64,67,0.38)",
									...
									onClick={() =>
										Utils.idGenerator.isRoomIDValid(_Value)
											? joinRoom(_Value)
											: undefined
									}
								>
				...
				<div className="LP-B-ImgList">
					<div className="LP-B-IL-Content">
						<button
							...
							onClick={() =>
								set_PresentationIndex(_PresentationIndex - 1)
							}
						>
							<svg
								width="24"
						...
						<div className="LP-B-IL-C-Content">
							<div className="LP-B-IL-C-C-TextImage">
								<img
									...
									src={PresentationPhotos[_PresentationIndex]}
								></img>
					...
					<div className="LP-B-IL-IndexList">
						<div
							className={`LP-B-IL-IL-Item ${
								_PresentationIndex === 0 ? "CurrentItem" : ""
							}`}
						></div>
						<div
							className={`LP-B-IL-IL-Item ${
								_PresentationIndex === 1 ? "CurrentItem" : ""
							}`}
						></div>
						<div
							className={`LP-B-IL-IL-Item ${
								_PresentationIndex === 2 ? "CurrentItem" : ""
							}`}
						></div>
					</div>
